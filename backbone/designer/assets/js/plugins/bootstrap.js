...
;(function() {
  ...
  Form.setTemplates({
    ...
    listItem: '\
      <li class="clearfix">\
        <button type="button" class="btn bbf-del pull-right" data-action="remove"><i class="icon-remove"></i></button>\
        {{editor}}\
      </li>\
    ',
    ...
    ',
      form_compact: '\
      <form><ul id="myTab" class="nav nav-tabs"><li class="item active"><a href="#item" data-toggle="tab">Item</a></li><li class="content"><a href="#content" data-toggle="tab">Content</a></li><li class="metadata"><a href="#metadata" data-toggle="tab">Extra</a></li></ul> {{fieldsets}}</form>\
    '
